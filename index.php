                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Order Food / Room</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2><b>Popular Dishes / Rooms </b></h2>
                    <p class="lead">"Indulge in a culinary journey by effortlessly ordering your favorite dish, with added room for personalization among the top 12 options!"</p>
                </div>
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"select * from dishes LIMIT 11"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-1 col-sm-16 col-md-6 food-item">
                                            ...
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order/Book Now</a> </div>
                                                </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Nagpur - Aurangabad - Mumbai Hwy, Vaijapur, Maharashtra 423701</p>
                                    <h5>Phone: 7620******</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>"Where Hospitality Meets Tranquility: Welcome to Hotel Vaishnavi, your serene sanctuary away from home."</p>
                                </div>
                    </div>
                </div>
