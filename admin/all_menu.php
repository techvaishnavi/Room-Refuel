...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                      ...
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu / Rooms</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_menu.php">All Menues / Rooms</a></li>
								<li><a href="add_menu.php">Add Menu / Rooms</a></li>
                              
                                
                            </ul>
                        </li>
						 <li> <a href="all_orders.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span>Customer Orders</span></a></li>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Menu / Rooms</h4>
                            </div>
            ...
            <footer class="footer"> © 2024 - Online Hotel Management & Food Ordering System </footer>
